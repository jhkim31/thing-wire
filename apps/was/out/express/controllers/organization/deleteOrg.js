...
function deleteOrg(req, res, next) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            const result = yield organization_1.default.deleteOrg(jwtPayload.id, orgId);
            res.status(200).json((0, createResponseMessage_1.default)("success", "delete Organization", result));
        }
        catch (error) {
            next(error);
        }
